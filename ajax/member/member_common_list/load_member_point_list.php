...
$rs = $memberCommonListDAO->selectMemberPointInfo($conn, "SEQ", $param);
$list = makeMemberPointListHtml($rs, $param);

$count_rs = $memberCommonListDAO->selectMemberPointInfo($conn, "COUNT", $param);
$rsCount = $count_rs->fields["cnt"];

$paging = mkDotAjaxPage($rsCount, $page, $scrnum, $list_num, "detailMovePage", "point");
