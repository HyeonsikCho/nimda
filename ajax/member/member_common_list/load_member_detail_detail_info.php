...
$origin_file_name = "<a href=\"/common/certi_file_down.php?seqno=" . $member_certi_seqno . "\">" . $certi_file_name . "</a><button onclick=\"removeCertiFile('" . $member_certi_seqno . "');\" type=\"button\" id=\"del_btn1\" class=\"btn btn-sm bred fa\" style=\"margin-left: 5px;\">이미지삭제</button>";
