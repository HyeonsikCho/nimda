...
$file_html = "<span style=\"font-size: 14px;font-weight: bold;padding: 10px 0;\"><a href=\"/common/order_detail_count_file_down.php?seqno=%s\">%s</a></span><br />";
$file_html1 = "<label class=\"fix_width99\"></label><span style=\"font-size: 14px;font-weight: bold;padding: 10px 0;\"><a href=\"/common/order_detail_count_file_down.php?seqno=%s\">%s</a></span><br />";
$work_file_html = <<<HTML
...
while ($sel_rs2 && !$sel_rs2->EOF) {
    ...
    if ($sel_rs2->fields["order_detail_count_file_seqno"] && $sel_rs2->fields["file_path"]) {
        ...
        $uploadedFileHtml .= "<a href=\"/common/order_detail_count_file_down.php?seqno=" . $sel_rs2->fields["order_detail_count_file_seqno"] . "\">" . $sel_rs2->fields["origin_file_name"] ." (";
