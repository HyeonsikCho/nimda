...
$rs = $dao->selectOutputOpProcessResultList($conn, $param);

$param["dvs"] = "COUNT";
$count_rs = $dao->selectOutputOpProcessResultList($conn, $param);
$rsCount = $count_rs->fields["cnt"];

$param["cnt"] = $rsCount;

$list = makeOutputOpProcessResultListHtml($rs, $param);
