...
$rs = $dao->selectFlattYTypsetList($conn, $param);
$list = makeFlattYTypsetListHtml($rs, $param);

$param["dvs"] = "COUNT";
$count_rs = $dao->selectFlattYTypsetList($conn, $param);
$rsCount = $count_rs->fields["cnt"];

$paging = mkDotAjaxPage($rsCount, $page, $scrnum, $list_num, "movePage", "flatt_y");
