...
$param["table"] = "cate"; 
$param["col"] = "cate_name";
$param["where"]["sortcode"] = $rs->fields["cate_sortcode"];

$html_param["cate_name"] = $dao->selectData($conn, $param)->fields["cate_name"];
        ...
        if ($order_detail_rs->fields["order_detail_seqno"]) {
            ...
            while ($seqno_rs && !$seqno_rs->EOF) {
                ...
                while ($picture_rs && !$picture_rs->EOF) {
                    ...
                    $chk_path = str_replace($_SERVER["DOCUMENT_ROOT"], "", $full_path);
