...
$rs = $dao->selectBasicAfterOpProcessList($conn, $param);

$param["dvs"] = "COUNT";
$count_rs = $dao->selectBasicAfterOpProcessList($conn, $param);
$rsCount = $count_rs->fields["cnt"];

$param["cnt"] = $rsCount;

$list = makeBasicAfterOpProcessListHtml($rs, $param);
$paging = mkDotAjaxPage($rsCount, $page, $scrnum, $list_num, "movePage", "basic_after");
