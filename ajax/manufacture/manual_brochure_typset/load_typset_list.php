...
$rs = $dao->selectBrochureTypsetList($conn, $param);

$param["dvs"] = "COUNT";
$count_rs = $dao->selectBrochureTypsetList($conn, $param);
$rsCount = $count_rs->fields["cnt"];

$param["cnt"] = $rsCount;

$list = makeBrochureTypsetListHtml($rs, $param);
