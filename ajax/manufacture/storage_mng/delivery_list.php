...
include_once($_SERVER["DOCUMENT_ROOT"] . "/com/nexmotion/html/manufacture/ManufactureMngHTML.php");
...
$param['catecode'] = $fb->form("catecode");
...
$param["dvs"] = "COUNT";
$count_rs = $dao->selectDeliveryList($conn, $param);
$rsCount = $count_rs->fields["cnt"];

$param["cnt"] = $rsCount;

$list = makeStorageListHtml($rs, $param);
