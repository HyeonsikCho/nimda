...
$param["outsource_etprs_cate_name"] = $fb->form("outsource_etprs_cate_name");
...
$rs = $dao->selectCooperatorList($conn, $param);

$param["dvs"] = "COUNT";
$count_rs = $dao->selectCooperatorList($conn, $param);
$rsCount = $count_rs->fields["cnt"];

$param["cnt"] = $rsCount;

$list = makeCooperatorListHtml($conn, $dao, $rs, $param);
