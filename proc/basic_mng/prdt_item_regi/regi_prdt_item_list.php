...
foreach ($seqno as $key=>$value) {
    ...
    //후공정
        ...
        //$affil_arr    = explode('!', substr($fb->form("affil"), 0, -1));
        //$subpaper_arr = explode('!', substr($fb->form("subpaper"), 0, -1));
        ...
        foreach ($size_arr as $size) {
            ...
            $temp["col"]["size"]     = $size;
            //$temp["col"]["affil"]    = $affil;
            //$temp["col"]["subpaper"] = $subpaper;
        ...
        /*
        foreach ($affil_arr as $affil) {
            foreach ($subpaper_arr as $subpaper) {
                $param["affil"]     = $affil;
