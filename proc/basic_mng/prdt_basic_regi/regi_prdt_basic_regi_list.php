...
if ($select_el == "paper") {
    ...
    if ($rs->EOF == 1) {
        ...
        if ($seqno == "") {
            ...
            $param["col"]["cpn_admin_seqno"]   = $fb->session("sell_site");
...
//사이즈
    ...
    $param["where"]["max_wid_size"] = $fb->form("max_wid_size");
    $param["where"]["max_vert_size"] = $fb->form("max_vert_size");
    ...
    if ($rs->EOF == 1) {
        ...
        $param["col"]["max_wid_size"] = $fb->form("max_wid_size");
        $param["col"]["max_vert_size"] = $fb->form("max_vert_size");
