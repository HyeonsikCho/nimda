...
include_once($_SERVER["DOCUMENT_ROOT"] . "/com/nexmotion/job/manufacture/typset_mng/ProcessViewDAO.php");
...
} else if ($pre_state == $state_arr["인쇄대기"]) { 
