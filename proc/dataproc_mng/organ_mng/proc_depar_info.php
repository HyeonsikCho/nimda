...
if (!$result) $check = 0;
$admin_seqno = $result->fields["depar_admin_seqno"];
//수정 및 추가 할 데이터 셋팅
$param = array();
$param["table"] = "depar_admin";
$param["col"]["depar_name"] = $depar_name;
$param["col"]["cpn_admin_seqno"] = $cpn_admin_seqno;
$param["col"]["depar_level"] = "2";

//부서 관리 수정
if ($fb->form("depar_admin_seq")) {

    //아무것도 수정하지 않고 저장버튼 클릭시
    if ($admin_seqno == $fb->form("depar_admin_seq")) {
    ...
    $param["prk"] = "depar_admin_seqno";
    $param["prkVal"] = $fb->form("depar_admin_seq");
