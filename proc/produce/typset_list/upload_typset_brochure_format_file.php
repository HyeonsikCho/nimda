...
// Settings
    ...
    $upload_path = SITE_DEFAULT_BROCHURE_TYPSET_FILE;
...
// Process the file
	...
	*/
    ...
    $brochure_typset_seqno = $fb->form("seqno");
    ...
    $order_detail_dvs_num = $dao->selectData($conn,$param)
                                ->fields["order_detail_dvs_num"];
    ...
    $param["col"]["order_detail_brochure_file_num"] = $order_detail_dvs_num . "01";

    $conn->StartTrans();
    $file_seqno = '';
    $rs = $dao->insertData($conn,$param);

    $file_seqno .= $conn->Insert_ID("brochure_typset_file") . '|';
