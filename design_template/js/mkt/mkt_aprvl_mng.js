...
var loadOfficeNick = function(event, search_str, dvs) {
    ...
    $.ajax({
            ...
            url: "/ajax/mkt/mkt_aprvl_mng/load_office_nick.php",
...
var tabCtrl = function(el, page, type) { 
    ...
    search_data.date_from =  $("#date_from").val();
    search_data.date_to =  $("#date_to").val();
    search_data.time_from = $("#time_from").val();
    search_data.time_to = $("#time_to").val();
