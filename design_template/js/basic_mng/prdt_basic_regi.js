...
var insertInfo = function(el, seqno, flag) {
    ...
    //사이즈
        ...
        size[14] = "max_wid_size";
        size[15] = "max_vert_size";
        ...
        size_alert[13] = "최대가로사이즈가 입력되지 않았습니다.";
        size_alert[14] = "최대세로사이즈가 입력되지 않았습니다.";
	...
	//validation
        ...
        data.max_wid_size = $.trim($("#pop_size_max_wid_size").val());
        data.max_vert_size = $.trim($("#pop_size_max_vert_size").val());
    ...
    //인쇄정보
        ...
        print_alert[2] = "계열이 선택되지 않았습니다.";
        print_alert[3] = "기준단위가 선택되지 않았습니다.";
        print_alert[4] = "카테고리대분류가 선택되지 않았습니다.";
