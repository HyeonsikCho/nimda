 ...
 ***********************************************************************************/
  ...
  ***********************************************************************************/
	 ...
	 function getDivAmtOrderDetailSheetInfoDataValue($conn, $nIdx) {
		 ...
		 $this->sql = "SELECT state, sheet_typset_seqno FROM "._TBL_AMT_ORDER_DETAIL_SHEET." ";
	 ...
	 function getDivAmtOrderDetailSheetMergeDataValue($conn, $nIdx) {
		 ...
		 $this->sql = "SELECT SUM(amt) AS amt, state, sheet_typset_seqno FROM "._TBL_AMT_ORDER_DETAIL_SHEET." ";
