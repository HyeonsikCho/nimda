...
function getPrdcPaperView($param) {
    ...
    <form name="paper_form" id="paper_form" method="post">
						                                  ...
						                                  <li>
				                                                ...
				                                                <input type="text" id="pur_rate" name="pur_rate" class="input_co2 fix_width180" onkeydown='return checkNumber(event)' onkeyup='removeChar(event)' maxlength="10" style='ime-mode:disabled;' value="$param[pur_rate]">				                                                <br />
				                                                <br />
