...
for ($i = 0; $i < $dup_count; $i++) {
    ...
    // 3.order_detail_count_file
    $detail_count_file_fields = $dao->selectOrderDetailCountFile($conn,
                                                                 $org_order_detail_seqno);
    $detail_count_file_fields["order_detail_dvs_num"] = $order_detail_dvs_num;
    $detail_count_file_fields["order_detail_seqno"] = $order_detail_seqno;
    $dao->insertOrderDetailCountFile($conn, $detail_count_file_fields);

    $org_order_detail_count_file_seqno = $detail_count_file_fields["order_detail_count_file_seqno"];
    $order_detail_count_file_seqno = $conn->Insert_ID();
