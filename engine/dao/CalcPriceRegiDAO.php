...
class CalcPriceRegiDAO extends CommonDAO {
     ...
     * @param $seqno   = 회사 일련번호
     *
     * @return $table_name_arr[0] = 합판금액 테이블
     * $table_name_arr[1] = 계산형금액 테이블
     */
    function selectPriceTableName($conn, $seqno) {
        ...
        $table_name_arr = explode('|', $rs->fields["price_tb_name"]);

        return $table_name_arr;
    }
